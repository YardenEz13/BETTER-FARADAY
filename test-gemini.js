...
const inputs = [
  ...
  { id: '2', original: 'חשב את השטח של ריבוע שצלעו  = 4$.' }
];
...
const userPrompt = \נושא: \

השאלות (בפורמט JSON):
\

החזר את אותו ה-JSON עם השאלות משוכתבות בהקשר של "\". חובה להחזיר מערך JSON של אובייקטים המכילים 'id' ו-'rewritten' לכל שאלה.\;
