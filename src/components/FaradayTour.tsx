...
export const STUDENT_TOUR_STEPS: TourStep[] = [
  {
    key: "map",
    title: "מפת הלמידה",
    body: "כל תחנה במסלול היא נושא. כל שאלה שנפתרת מטעינה את התחנה ופותחת את הבאה בתור.",
  },
  {
    key: "stats",
    title: "הרצף והאנרגיה",
    body: "כאן עוקבים אחרי הרצף היומי, נקודות האנרגיה (XP) והרמה. כדאי לשמור על הרצף כל יום!",
  },
  {
    key: "daily",
    title: "הניסוי היומי",
    body: "בכל יום פרופסור פאראדיי בוחר אתגר חדש. השלמה שלו שומרת על המומנטום.",
  },
  {
    key: "tutor",
    title: "מורה ה-AI",
    body: "משהו נתקע? פרופסור פאראדיי כאן עם רמזים והסברים — בכל שלב.",
  },
];
